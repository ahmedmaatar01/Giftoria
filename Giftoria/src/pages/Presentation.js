        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">Giftoria Admin Center</h1>
              ...
              <div className="d-flex align-items-center justify-content-center">
                ...
                <GitHubButton className="mt-lg-2" href="https://github.com/themewagon/Giftoria" data-size="large" data-show-count="true" aria-label="Star themesberg/Giftoria on GitHub">Star</GitHubButton>
              </div>
        ...
        <Container>
          ...
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5}>
              ...
              <Button as={Link} to={Routes.BootstrapTables.path} variant="secondary" className="mb-5 mb-lg-0" target="_blank"><FontAwesomeIcon icon={faReact} className="me-1" /> Components examples</Button>
            </Col>
        ...
        <Container>
          <Row>
            <Col xs={12} lg={8}>
              ...
              <p className="lead mb-4 me-lg-6">Do you want to take React development to the next level? Check out the premium version of Giftoria Admin Center in the following comparison table.</p>
            </Col>
            <Col xs={12} lg={4}>
