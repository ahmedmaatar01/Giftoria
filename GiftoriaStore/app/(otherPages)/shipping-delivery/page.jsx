          ...
          <div className="tf-main-area-page tf-page-delivery">
            {isArabic ? (
              <>
                <div className="box">
                  <h4>التوصيل</h4>
                  <p>جميع الطلبات يتم شحنها عبر UPS Express.</p>
                  <p>الشحن مجاني دائماً للطلبات التي تزيد عن 250 دولار أمريكي.</p>
                  <p>جميع الطلبات يتم شحنها مع رقم تتبع UPS.</p>
                </div>
                <div className="box">
                  <h4>الإرجاع</h4>
                  <p>العناصر التي يتم إرجاعها خلال 14 يومًا من تاريخ الشحن الأصلي وفي حالة جديدة ستكون مؤهلة لاسترداد كامل أو رصيد متجر.</p>
                  <p>سيتم إعادة المبالغ المستردة إلى وسيلة الدفع الأصلية المستخدمة في الشراء.</p>
                  <p>العميل مسؤول عن رسوم الشحن عند إجراء الإرجاع، ورسوم الشحن/المناولة للشراء الأصلي غير قابلة للاسترداد.</p>
                  <p>جميع العناصر المباعة نهائية ولا يمكن إرجاعها.</p>
                </div>
                <div className="box">
                  <h4>المساعدة</h4>
