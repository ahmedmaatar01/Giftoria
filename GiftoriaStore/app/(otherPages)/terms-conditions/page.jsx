        ...
        <div className="container">
          <div className="tf-main-area-page tf-terms-conditions">
            {isArabic ? (
              <>
                <div className="box">
                  <h4>قد تتغير هذه الشروط والأحكام</h4>
                  <p>نحتفظ بالحق في تحديث أو تعديل هذه الشروط والأحكام في أي وقت دون إشعار مسبق. استخدامك لموقع shop.company.com و shop.beetle.com.sg بعد أي تغيير من هذا القبيل يشكل موافقتك على الالتزام بالشروط والأحكام كما تم تغييرها. لهذا السبب، نشجعك على مراجعة هذه الشروط والأحكام كلما استخدمت هذا الموقع.</p>
                </div>
                <div className="box">
                  <h4>حدود المسؤولية</h4>
                  <p>لا تتحمل الشركة أي مسؤولية، ولن تكون مسؤولة عن أي أضرار أو فيروسات قد تصيب جهاز الكمبيوتر أو معدات الاتصالات أو الممتلكات الأخرى الخاصة بك بسبب أو نتيجة وصولك إلى هذا الموقع أو استخدامه أو تصفحه أو تنزيل أي مواد منه. لن تكون الشركة أو أي من مسؤوليها أو مديريها أو موظفيها أو مساهميها أو وكلائها أو خلفائها أو شركائها أو أي طرف مشارك في إنشاء أو إنتاج أو نقل هذا الموقع مسؤولة تجاه أي طرف عن أي أضرار غير مباشرة أو خاصة أو عقابية أو عرضية أو تبعية (بما في ذلك، على سبيل المثال لا الحصر، تلك الناتجة عن فقدان الأرباح أو فقدان البيانات أو انقطاع الأعمال) الناشئة عن استخدام أو عدم القدرة على استخدام أو نتائج استخدام هذا الموقع أو أي مواقع مرتبطة بهذا الموقع أو المواد أو المعلومات أو الخدمات الموجودة في أي من هذه المواقع، سواء كان ذلك بناءً على ضمان أو عقد أو ضرر أو أي نظرية قانونية أخرى وسواء تم إخطار الشركة بإمكانية حدوث مثل هذه الأضرار أم لا. لا تنطبق حدود المسؤولية السابقة إلى الحد الذي يحظره القانون. يرجى الرجوع إلى القوانين المحلية الخاصة بك لأي من هذه المحظورات.</p>
                  <p>في حالة وجود أي مشكلة مع هذا الموقع أو أي محتوى، فإنك توافق على أن العلاج الوحيد لك هو التوقف عن استخدام هذا الموقع. في حالة وجود أي مشكلة مع المنتجات أو الخدمات التي اشتريتها على أو من خلال هذا الموقع، فإنك توافق على أن العلاج الخاص بك، إذا وجد، هو من الشركة المصنعة لهذه المنتجات أو المورد لهذه الخدمات، وفقًا لضمان الشركة المصنعة أو المورد، أو السعي للحصول على استرداد لهذه المنتجات أو الخدمات وفقًا لسياسات الإرجاع والاسترداد المنشورة على هذا الموقع. قد يتضمن هذا الموقع عدم دقة أو أخطاء أو أخطاء مطبعية. لا تضمن CharlesKeith.com أن المحتوى سيكون دون انقطاع أو خالي من الأخطاء.</p>
                </div>
                <div className="box">
                  <h4>حقوق النشر والعلامات التجارية</h4>
                  <p>ما لم يُذكر خلاف ذلك، فإن المواد الموجودة على هذا الموقع، بما في ذلك على سبيل المثال لا الحصر النصوص والصور والرسوم التوضيحية والبرامج ومقاطع الصوت ومقاطع الفيديو وملفات الرسوم المتحركة، تخضع لحقوق النشر والعلامات التجارية لشركة The Company Private Limited. وبالتالي، لا يجوز نسخ أو إعادة إنتاج أو تعديل أو نشر أو نقل أو توزيع المواد الموجودة على هذا الموقع، كليًا أو جزئيًا، بأي شكل من الأشكال، دون الحصول على موافقة خطية مسبقة من The Company Private Limited. جميع الحقوق محفوظة.</p>
                </div>
                <div className="box">
                  <h4>المنتجات والمحتوى والمواصفات</h4>
                  <p>جميع الميزات والمحتوى والمواصفات والمنتجات وأسعار المنتجات والخدمات الموضحة أو المصورة على هذا الموقع قابلة للتغيير في أي وقت دون إشعار. بعض الأوزان والمقاييس والأوصاف المماثلة تقريبية ومقدمة لأغراض الراحة فقط. نبذل جميع الجهود المعقولة لعرض سمات منتجاتنا بدقة، بما في ذلك الألوان المطبقة؛ ومع ذلك، فإن اللون الفعلي الذي تراه سيعتمد على نظام الكمبيوتر الخاص بك ولا يمكننا ضمان أن يعرض جهاز الكمبيوتر الخاص بك هذه الألوان بدقة. لا يعني تضمين أي منتجات أو خدمات في هذا الموقع في وقت معين أن هذه المنتجات أو الخدمات ستكون متاحة في أي وقت. تقع على عاتقك مسؤولية التأكد من الامتثال لجميع القوانين المحلية والدولية المتعلقة بحيازة واستخدام وبيع أي عنصر تم شراؤه من هذا الموقع. من خلال تقديم طلب، فإنك تقر بأن المنتجات المطلوبة ستستخدم فقط بطريقة قانونية.</p>
                </div>
                <div className="box">
                  <h4>قيود الشحن</h4>
                  <p>عند تقديم طلب، سيتم شحنه إلى عنوان يحدده المشتري طالما أن عنوان الشحن هذا يتوافق مع قيود الشحن الواردة في هذا الموقع. جميع المشتريات من هذا الموقع تتم بموجب عقد شحن. نتيجة لذلك، تنتقل مخاطر الفقدان وملكية العناصر المشتراة من هذا الموقع إليك عند تسليم العناصر إلى الناقل. أنت مسؤول عن تقديم أي مطالبات إلى شركات النقل بشأن الشحنات التالفة و/أو المفقودة.</p>
                </div>
                <div className="box">
                  <h4>الرسوم والضرائب</h4>
                  <p>أنت مسؤول عن الرسوم والضرائب خارج سنغافورة. جميع العناصر التي تدخل دولة أجنبية تخضع للتفتيش الجمركي وتقييم الرسوم والضرائب وفقًا لقوانين تلك الدولة الوطنية.</p>
                </div>
                <div className="box">
                  <h4>حسابك</h4>
                  <p>أنت مسؤول عن الحفاظ على سرية معلومات حسابك وكلمة المرور الخاصة بك، وتوافق على تحمل المسؤولية عن جميع الأنشطة التي تحدث ضمن حسابك وكلمة المرور الخاصة بك. يحتفظ هذا الموقع وشركة The Company Pte Ltd بالحق في رفض الخدمة، وإنهاء الحسابات، وإزالة أو تحرير المحتوى أو إلغاء الطلبات. من خلال تقديم طلب، فإنك تضمن أنك تجاوزت 18 عامًا من العمر، وأنك تقدم معلومات دقيقة وصحيحة إلى shop.company.com أو shop.beetle.com.sg وأن لديك السلطة لتقديم الطلب.</p>
                </div>
                <div className="box">
                  <h4>سياسة الاستبدال والاسترداد (فروع سنغافورة فقط)</h4>
                  <p>يمكن استبدال البضائع الجديدة غير المستخدمة التي تم شراؤها بسعر كامل في متجر البيع بالتجزئة في أي بوتيك مع إيصال أصلي خلال 7 أيام من الشراء. بعد 7 أيام، لا يمكن استبدال البضائع. نقدم سياسة عدم استرداد على جميع البضائع، ومع ذلك، بالنسبة للبضائع المؤهلة للاستبدال، يمكن استبدال العنصر برصيد متجر يمكن استخدامه في فروعنا في سنغافورة فقط. لا يمكن استبدال أو إرجاع البضائع المعروضة للبيع. يجب إعادة جميع البضائع في حالة قابلة للبيع، وإلا فلن يُسمح بالاستبدال. نحتفظ بالحق في رفض أي شكل من أشكال الاستبدال دون الإيصال الأصلي.</p>
                </div>
                <div className="box">
                  <h4>سياسة الاستبدال والاسترداد (المتجر الإلكتروني)</h4>
                  <span>الاتصالات الإلكترونية</span>
                  <p>عند زيارتك لهذا الموقع و/أو إرسال بريد إلكتروني إلينا، فإنك توافق على تلقي الاتصالات الإلكترونية منا. توافق على أن جميع الاتفاقيات والإشعارات والإفصاحات وغيرها من الاتصالات التي نرسلها إليك إلكترونيًا تفي بأي متطلبات قانونية بأن تكون هذه الاتصالات مكتوبة.</p>
                  <p>استثناءات الضمانات<br />لا تقدم شركة The Company Private Limited أي تمثيل أو ضمان بشأن حسن سير أو حالة هذا الموقع، أو ملاءمته للاستخدام، أو أن استخدامه سيكون دون انقطاع أو خالي من الأخطاء. يتم توفير جميع المعلومات أو المواد المقدمة في هذا الموقع لك "كما هي" وبدون أي ضمانات من أي نوع، سواء كانت صريحة أو ضمنية، بما في ذلك على سبيل المثال لا الحصر، الضمانات أو الشروط المتعلقة بالتسويق أو الملاءمة أو الجودة أو المتانة أو الملاءمة لغرض معين أو عدم الانتهاك.</p>
                </div>
              </>
            ) : (
              <>
