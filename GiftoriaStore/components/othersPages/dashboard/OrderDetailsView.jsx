...
export default function OrderDetailsView({ orderId, requireAuth = true }) {
  ...
  const tabTitles = [
    ...
    ...(requireAuth && authToken ? [t("order_details.my_notes")] : []),
    ...
    <div className="wd-form-order">
      ...
      <div className="widget-tabs style-has-border widget-order-tab">
        ...
        <div className="widget-content-tab">
          ...
          {/* My Notes - only show if auth required */}
          ...
          {/* Order Info */}
          <div className={"widget-content-inner" + (activeTab === (requireAuth && authToken ? 4 : 3) ? " active" : "")}
            style={{ display: activeTab === (requireAuth && authToken ? 4 : 3) ? 'block' : 'none', direction: i18n.language === 'ar' ? 'rtl' : 'ltr' }}>
            <ul className="mt_20">
              <li>
