          ...
          <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '400px' }}>
            <div className="w-100 text-center">
              <p className="bell-t-medium" style={{fontSize: '20px', lineHeight: '1.7', margin: 0}}>
                GIFTORIA.me is a luxury brand born from a desire to transform the art of gifting into an unforgettable, emotional experience. <br /> Every detail, from the design of our products to the personal touch behind each gift, is carefully crafted to reflect elegance, intention, and meaning.<br /><br />
